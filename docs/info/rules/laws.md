...
??? note-cc "11. Правила территорий"
    ...
    `11.3.` Свод правил частной территории должен не противоречить действующим Заповедям и Законам.
        
    - `11.4.` В случае, если наказание за нарушение не предусмотренно сводом правил территории, то нарушитель будет караться действующими законами страны.
    
    - `11.5` Написать репорт за нарушение правил на своей территории может только владелец данной территории.
        
    `11.6.` Максимальное наказание, которое может быть потребовано и прописано в своде правил это либо 250 АР штрафа, либо 1 сутки Внешнего мира тюремного заключения.
      
    `11.7.` Посетитель территории должен быть осведомлен о действующих правилах территории. 
    ...
    `11.8.` Любой свод правил частной территории подразумевает, что котик покидает запретную территорию в момент, когда тот узнает об ограничении на посещение территории. В ситуации, где котик не знал об ограничении на вход, котику дается время на то, чтобы покинуть территорию.

    `11.9.` Если владельцы частных территорий/городов хотят, чтобы котенок покинул их территорию, они имеют право не позволять заходить и/или выгонять со своей территории.
    
     - При однократном невыполнении просьбы владельца покинуть территорию – штраф 50 АР.
     
     - При многократном невыполнении просьбы владельца покинуть территории (явное требование последовало 3 или более раз в чате игры) – владелец имеет право физически устранить нарушителя, с последующем обязательством возвратить ресурсы.
     
    `11.10.` Котенок имеет право находиться на запретной территории, если получил разрешение от владельца территории в чате игры.
    
    `11.11.` Котёнок, имеющий статус парламентёра и выше, имеет право беспрепятственно находиться на частной территории/города независимо от правил территории в том случае, если появилась необходимость в проверки территории/прописанных правил на законность.
...
??? note-cc "12. Бесхозные земли"
    ...
    - `12.2.` В случае выставления на продажу, необходимо рассчитать стоимость земли по данным пунктам:
    ...
    `12..` Территории, выставленные на продажу, может купить любой гражданин страны. Для покупки земли, необходимо составить договор купле-продаже, между государством и покупателем, по следующим пунктам:
...
??? note-cc "8. Минимальные цены на продажу"
    !!! danger ""
